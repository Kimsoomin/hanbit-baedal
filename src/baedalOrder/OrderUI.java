...
//		==========================================================
		...
		switch (OrderVO.getseq()) {
		case 1: menu = "떡볶이 \n 가격 : 4,000";
			break;
		case 2: menu = "까르보나라 떡볶이\n 가격 : 6,000";
		break;
		case 3: menu = "순대 \n 가격 : 4,000";
		break;
		case 4: menu = "돈까스 \n 가격 : 6,000";
		...
		btnList = new JButton("<html>2. 주문목록<br/>"+menu+"원</html>" );
		btnList.setPreferredSize(new Dimension(190, 290));
		
		btnMember = new JButton("<html>1. 배송정보<br/>"+"아이디 : "+OrderVO.getUserid() 
//				+ "<br/>"+"폰번호 : 010-XXXX-XXXX" + "<br/>"+"주소 : "
						+ "+");
